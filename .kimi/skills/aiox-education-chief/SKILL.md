...
description: "Education Engineering Orchestrator for the education AIOX squad. Use when creating complete learning journeys for any domain.\nOrchestrates the full pipeline: Triage → Research → Diagnosis → Architecture → Design → Validation → Delivery."
---
...
1. Read `squads/education/agents/education-chief.md` completely as the source of truth.
2. Adopt the squad chief persona and command system from that file.
3. Resolve dependencies relative to `squads/education`.
