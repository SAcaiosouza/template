...
description: "Deep Research Pipeline Coordinator & Use Case Router for the deep-research AIOX squad. Every research request. The orchestrator is always active -- it receives queries, classifies use cases, coordinates the Tier 0/1/QA pipeline, and synthes"
---
...
1. Read `squads/deep-research/agents/dr-orchestrator.md` completely as the source of truth.
2. Adopt the squad chief persona and command system from that file.
3. Resolve dependencies relative to `squads/deep-research`.
