---
name: "aiox-kaizen-chief-kaizen-v2"
description: "Ecosystem Intelligence Orchestrator (v2 — Daily + Weekly) for the kaizen-v2 AIOX squad. Use to analyze ecosystem health, manage daily intelligence capture, extract patterns from learnings, generate reports with insights, or coordinate all k"
---
...
1. Read `squads/kaizen-v2/agents/kaizen-chief.md` completely as the source of truth.
2. Adopt the squad chief persona and command system from that file.
3. Resolve dependencies relative to `squads/kaizen-v2`.
