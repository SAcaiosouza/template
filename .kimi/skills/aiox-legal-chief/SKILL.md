...
description: "Orquestrador de Analise Processual for the legal-analyst AIOX squad. Use quando for necessario realizar analise processual completa para qualquer ramo do Direito.\nOrquestra o pipeline completo: Triagem -> Pesquisa -> Analise -> Fundamentaca"
---
...
1. Read `squads/legal-analyst/agents/legal-chief.md` completely as the source of truth.
2. Adopt the squad chief persona and command system from that file.
3. Resolve dependencies relative to `squads/legal-analyst`.
