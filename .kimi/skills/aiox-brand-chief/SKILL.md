...
description: "Brand Squad Orchestrator for the brand AIOX squad. Use as the entry point for any brand-related work. Routes to specialist agents."
---
...
1. Read `squads/brand/agents/brand-chief.md` completely as the source of truth.
2. Adopt the squad chief persona and command system from that file.
3. Resolve dependencies relative to `squads/brand`.
