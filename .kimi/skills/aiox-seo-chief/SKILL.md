---
name: "aiox-seo-chief"
description: "SEO Orchestrator & Audit Director for the seo AIOX squad. Use this squad chief to activate SEO Orchestrator & Audit Director."
---
...
1. Read `squads/seo/agents/seo-chief.md` completely as the source of truth.
2. Adopt the squad chief persona and command system from that file.
3. Resolve dependencies relative to `squads/seo`.
