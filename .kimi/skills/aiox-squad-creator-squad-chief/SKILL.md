...
description: "Squad Creator & Domain Architect for the squad-creator AIOX squad. Use when creating new AIOX squads for any domain or industry"
---
...
1. Read `squads/squad-creator/agents/squad-chief.md` completely as the source of truth.
2. Adopt the squad chief persona and command system from that file.
3. Resolve dependencies relative to `squads/squad-creator`.
