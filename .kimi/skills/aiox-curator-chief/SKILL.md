...
description: "Content Curation Orchestrator for the curator AIOX squad. Use this squad chief to activate Content Curation Orchestrator."
---
...
1. Read `squads/curator/agents/curator-chief.md` completely as the source of truth.
2. Adopt the squad chief persona and command system from that file.
3. Resolve dependencies relative to `squads/curator`.
