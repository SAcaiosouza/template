...
description: "Ecosystem Intelligence Orchestrator for the kaizen AIOX squad. Use when you need to analyze the health of the AI agent ecosystem, detect gaps in competencies or tools, monitor performance, track costs, or generate weekly resource recommenda"
---
...
1. Read `squads/kaizen/agents/kaizen-chief.md` completely as the source of truth.
2. Adopt the squad chief persona and command system from that file.
3. Resolve dependencies relative to `squads/kaizen`.
