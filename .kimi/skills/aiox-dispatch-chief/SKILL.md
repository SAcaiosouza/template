...
description: "Pipeline Orchestrator for the dispatch AIOX squad. Use when you have 3+ tasks to execute in parallel, or any structured story/PRD that needs decomposition and execution"
---
...
1. Read `squads/dispatch/agents/dispatch-chief.md` completely as the source of truth.
2. Adopt the squad chief persona and command system from that file.
3. Resolve dependencies relative to `squads/dispatch`.
